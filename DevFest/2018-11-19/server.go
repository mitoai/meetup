...
func main() {
	...
	println("=========================")
	println("")
	println("📄 https://mito.ai/api-graphql-dynamic/?url=http%3A%2F%2Flocalhost%3A1337%2Fgraphql")
	println("🛠  http://localhost:1337/graphql")
	println("")
	err = http.ListenAndServe(":1337", cors.Default().Handler(mux))
	if err != nil {
